...
- Never push directly to `main`. Create a dedicated feature or upstream-sync branch.
- All AI-authored changes must be pushed and proposed by the `andylee1007-ai` GitHub account.
